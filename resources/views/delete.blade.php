    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Delete File</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="container mt-5">
                <form action="{{route('meeting.delete', $file->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <h3 class="text-center mb-5">Apakah Anda Yakin Ingin Hapus File?</h3>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_doc" class="form-control"
                               value="{{old('jenis_doc') ?? $file->jenis_doc }}">
                    </div>
...
@include('sweet::alert', ['cdn' => "https://cdn.jsdelivr.net/npm/sweetalert2@9"])
</body>
</html>
