        ...
        <section class="content">
            <div class="container mt-5">
                <div class="pull-right">
                    <a href="{{route('training.delete', $file->id)}}" class="btn btn-outline-danger"><i class="fa fa-trash-alt"></i> Delete</a>
                    @if(auth()->user()->role == 'admin')
                        <a href="{{route('logActivity', $file->id)}}" class="btn btn-outline-info"><i class="fa fa-info"></i> Detail</a>
                    @endif
                    <a href="{{route('training.edit', $file->id)}}" class="btn btn-outline-primary"><i class="fa fa-edit"></i> Edit</a>
                </div>
