    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Trash Data Meeting</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Trash Meeting Report</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="pull-right">
                                    <a href="{{route('meeting')}}" class="btn btn-success"><i class="fa fa-file"></i> Meeting Report</a>
                                </div>
                                <div class="card-body">
...
<script>
    $().ready(function () {
        $("#trashmeeting").DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{route('meeting.getTrash')}}",
            "columns": [
